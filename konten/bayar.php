...
<td>
    ...
    <?= $kolom['status_verifikasi'];?>
                                ...
                                <td> 
                                    ...
                                    <!-- Tombol konfrimasi     -->
                                    <a onclick="return confirm('Yakin akan menghapus data ini?')" href="index.php?p=bayar-konfirmasi&id_bayar=<?=$kolom['id_bayar'];?>" title="Konfirmasi Pembayaran Ini?"><i class="fas fa-check"></i></a>
                                    &nbsp;
                                <?php } ?>
                                    <!-- Tombol Hapus  -->
                                    <a onclick="return confirm('Yakin akan menghapus data ini?')" href="aksi/bayar.php?aksi=hapus&id_biaya=<?= $kolom['id_bayar']; ?>" title="Hapus Pembayaran"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
<!-- Modal Ubah Biaya -->
<div class="modal fade" id="modalUbah<?= $kolom['id_bayar']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
