      ...
      <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Data Biaya</h5>
            <div class="card-body">
              <button class="btn bg-purple mb-2"
               data-toggle="modal"
               data-target="#modalRecycleBin"><i class="fas fa-recycle"></i> Recycle Bin</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="aksi/biaya.php" method="post">
            ...
            <select name="id_jurusan" class="form-control" required><option value="">-- Pilihan Jurusan --</option>
            <?php
            ...
            <button type="submit" class="btn btn-block bg-purple"> <i class="fas fa-save"></i>Simpan</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="aksi/biaya.php" method="post">
            ...
            <label for="jumlah_biaya">Jumlah_biaya</label>
            <input type="text" name="jumlah_biaya" class="form-control" required>
                     ...
                     ?> 
                        <tr>
                            ...
                            <td>
                               ...
                               &nbsp;
                               <a onclick="return confirm('Yakin akan menghapus data ini?')" href="aksi/biaya.php?aksi=hapus-permanen&id_biaya=<?= $kolom['id_biaya']; ?>"><i class="fas fa-eraser"></i></a> </td>
                        </tr>
