            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="pdf/output/laporan_peserta_didik.php" target="_blank" class="small-box-footer">Cetak
            ...
            <div class="modal-body">
                <form action="pdf/output/laporan_pembayaran_siswa.php" method="get" target="_blank">
                    ...
                    <select name="id_siswa" class="form-control" required>
                        ...
                        <?php $sql="SELECT * FROM siswa WHERE dihapus_pada IS NULL ORDER BY nis ASC";
